...
def load_data_perusahaan():
    ...
    possible_names = ["data_perusahaan.xlsx", "data_perusahaan.xls"]
...
def load_data_penera():
    ...
    possible_names = ["data_penera.xlsx", "data_penera.xls"]
...
if mode == "📝 Input Data Pengujian":
    ...
    with col_extra2:
        keterangan = st.selectbox(
            "Jenis Pengujian",
            ["Tera", "Tera Ulang"],
            index=0 if st.session_state.saved_data.get('keterangan', 'Tera') == 'Tera' else 1
        )
